defmodule ShiftplanerWebWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ShiftplanerWebWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/shiftplaner_web_web/templates",
                        namespace: ShiftplanerWebWeb
